...
<div class="animate-children flex flex-col md:flex-row gap-8 mb-12">
    <div class="flex-1">
        ...
        <p>Wir glauben an den dreieinigen Gott der Bibel und erleben Ihn persönlich sowie gemeinsam als Gemeinde.
            ...
            internationalen Vineyard-Verbandes.</p>
...
<div class="flex flex-col md:flex-row gap-8 mt-12">
    ...
    <div class="flex-1">
        <img
            class="w-full h-auto block mb-4"
            src="https://vineyard-landsberg.de/wp-content/uploads/2019/06/20190626-Hope-800x500.jpg"
            srcset="https://vineyard-landsberg.de/wp-content/uploads/2019/06/20190626-Hope-800x500.jpg 800w, https://vineyard-landsberg.de/wp-content/uploads/2019/06/20190626-Hope-800x500-300x188.jpg 300w, https://vineyard-landsberg.de/wp-content/uploads/2019/06/20190626-Hope-800x500-768x480.jpg 768w, https://vineyard-landsberg.de/wp-content/uploads/2019/06/20190626-Hope-800x500-400x250.jpg 400w"
            sizes="(max-width: 800px) 100vw, 800px"
            alt="Hoffnung"
        />
...
<div class="animate-children flex flex-col md:flex-row gap-8 mb-12">
    ...
    <div class="flex-1">
        ...
        <p>Finde heraus, was es heißt, unter der Herrschaft Jesu zu leben.</p>
